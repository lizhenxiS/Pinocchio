...
public:
    ...
    QStackedWidget *previewWidget;
    QWidget *page;
    QWidget *page_2;
    QPushButton *LastPreModelButton;
    QPushButton *NextPreModelButton;
    QPushButton *OkPreModelButton;
    ...
    void setupUi(QWidget *ModelHandleClass)
    {
        ...
        groupBox_2->setGeometry(QRect(1120, 70, 270, 420));
        groupBox_2->setFont(font);
        previewWidget = new QStackedWidget(groupBox_2);
        previewWidget->setObjectName(QStringLiteral("previewWidget"));
        previewWidget->setGeometry(QRect(10, 20, 250, 400));
        page = new QWidget();
        page->setObjectName(QStringLiteral("page"));
        previewWidget->addWidget(page);
        page_2 = new QWidget();
        page_2->setObjectName(QStringLiteral("page_2"));
        previewWidget->addWidget(page_2);
        LastPreModelButton = new QPushButton(ModelHandleClass);
        LastPreModelButton->setObjectName(QStringLiteral("LastPreModelButton"));
        LastPreModelButton->setGeometry(QRect(1150, 510, 60, 30));
        QFont font2;
        font2.setBold(false);
        font2.setWeight(50);
        LastPreModelButton->setFont(font2);
        NextPreModelButton = new QPushButton(ModelHandleClass);
        NextPreModelButton->setObjectName(QStringLiteral("NextPreModelButton"));
        NextPreModelButton->setGeometry(QRect(1300, 510, 60, 30));
        OkPreModelButton = new QPushButton(ModelHandleClass);
        OkPreModelButton->setObjectName(QStringLiteral("OkPreModelButton"));
        OkPreModelButton->setGeometry(QRect(1230, 500, 50, 50));
    ...
    void retranslateUi(QWidget *ModelHandleClass)
    {
        ...
        groupBox_2->setTitle(QApplication::translate("ModelHandleClass", "\351\242\204\350\247\210\346\250\241\345\236\213", 0));
        LastPreModelButton->setText(QApplication::translate("ModelHandleClass", "Last", 0));
        NextPreModelButton->setText(QApplication::translate("ModelHandleClass", "Next", 0));
        OkPreModelButton->setText(QApplication::translate("ModelHandleClass", "OK", 0));
